...
const styles = StyleSheet.create({
  ...
  heading: { color: "#11181C", fontSize: 20, fontWeight: "800", letterSpacing: -0.25 },
  headingAction: { paddingHorizontal: 3, paddingVertical: 6 },
  headingActionText: { color: "#0A7EA4", fontSize: 13, fontWeight: "800" },
  pressed: { opacity: 0.68 },
  empty: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#E3E8F3", borderRadius: 20, borderWidth: 1, padding: 26 },
  emptyTitle: { color: "#11181C", fontSize: 16, fontWeight: "800", marginTop: 10 },
