...
const styles = StyleSheet.create({
  ...
  choiceSelected: { backgroundColor: "#F3F4F6", borderColor: "#2446A8" },
  ...
  appearanceChoiceSelected: { backgroundColor: "#F3F4F6", borderColor: "#2446A8" },
