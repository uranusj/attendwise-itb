...
const styles = StyleSheet.create({
  ...
  formulaText: { color: "#0A7EA4", flex: 1, fontSize: 12, fontWeight: "600", lineHeight: 17 },
  listTitle: { color: "#11181C", fontSize: 18, fontWeight: "800", marginBottom: 11, marginTop: 22 },
  ...
  subject: { color: "#11181C", fontSize: 16, fontWeight: "800" },
  ...
  statValue: { color: "#11181C", fontSize: 16, fontWeight: "800" },
  ...
  projectionStrong: { color: "#0A7EA4", fontWeight: "800" },
