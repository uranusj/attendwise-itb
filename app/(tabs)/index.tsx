...
const styles = StyleSheet.create({
  ...
  listContent: { backgroundColor: "#FFFFFF", padding: 18, paddingBottom: 40 },
  heroRow: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", marginBottom: 18, marginTop: 4 },
  greeting: { color: "#11181C", fontSize: 23, fontWeight: "800", letterSpacing: -0.55 },
  cohort: { color: "#6D7A94", fontSize: 12, fontWeight: "700", marginTop: 5 },
  avatar: { alignItems: "center", backgroundColor: "#F3F4F6", borderRadius: 18, height: 42, justifyContent: "center", width: 42 },
  avatarText: { color: "#0A7EA4", fontSize: 17, fontWeight: "800" },
  attendanceHero: { backgroundColor: "#F5F5F5", borderColor: "#E5E7EB", borderRadius: 24, borderWidth: 1, flexDirection: "row", justifyContent: "space-between", marginBottom: 14, overflow: "hidden", padding: 21 },
  overallLabel: { color: "#687076", fontSize: 10, fontWeight: "800", letterSpacing: 1.05 },
  overallValue: { color: "#11181C", fontSize: 39, fontWeight: "800", letterSpacing: -1.5, marginTop: 3 },
  percentMark: { color: "#687076", fontSize: 20 },
  targetText: { color: "#687076", fontSize: 12, fontWeight: "600" },
  ...
  nextCard: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#E5E7EB", borderRadius: 20, borderWidth: 1, flexDirection: "row", marginBottom: 24, padding: 15 },
  nextIcon: { alignItems: "center", backgroundColor: "#F3F4F6", borderRadius: 14, height: 46, justifyContent: "center", width: 46 },
  nextBody: { flex: 1, marginLeft: 12 },
  nextLabel: { color: "#6D7A94", fontSize: 10, fontWeight: "800", letterSpacing: 0.8 },
  nextTitle: { color: "#11181C", fontSize: 16, fontWeight: "800", marginTop: 2 },
  nextDetail: { color: "#6D7A94", fontSize: 12, marginTop: 2 },
  lectureCard: { backgroundColor: "#FFFFFF", borderColor: "#E5E7EB", borderRadius: 20, borderWidth: 1, flexDirection: "row", marginBottom: 10, overflow: "hidden", padding: 14 },
  lectureTime: { borderRightColor: "#E5E7EB", borderRightWidth: 1, paddingRight: 12, width: 61 },
  timeStart: { color: "#11181C", fontSize: 14, fontWeight: "800" },
  timeEnd: { color: "#7A879E", fontSize: 11, marginTop: 3 },
  lectureBody: { flex: 1, marginLeft: 13 },
  lectureSubject: { color: "#11181C", fontSize: 16, fontWeight: "800" },
  ...
  attentionCard: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#E5E7EB", borderRadius: 18, borderWidth: 1, flexDirection: "row", padding: 14 },
  ...
  attentionTitle: { color: "#11181C", fontSize: 14, fontWeight: "800" },
  ...
  brandMark: { alignItems: "center", backgroundColor: "#0A7EA4", borderRadius: 20, height: 63, justifyContent: "center", width: 63 },
  setupEyebrow: { color: "#0A7EA4", fontSize: 10, fontWeight: "800", letterSpacing: 1.3, marginTop: 18 },
  setupTitle: { color: "#11181C", fontSize: 38, fontWeight: "800", letterSpacing: -1.4, lineHeight: 42, marginTop: 7, textAlign: "center" },
  setupDetail: { color: "#6D7A94", fontSize: 14, lineHeight: 21, marginTop: 10, textAlign: "center" },
  setupCard: { backgroundColor: "#FFFFFF", borderColor: "#E5E7EB", borderRadius: 24, borderWidth: 1, marginTop: 25, padding: 19, width: "100%" },
  fieldLabel: { color: "#6D7A94", fontSize: 10, fontWeight: "800", letterSpacing: 0.85 },
  sectionLabel: { marginTop: 18 },
  textInput: { borderBottomColor: "#E5E7EB", borderBottomWidth: 1, color: "#11181C", fontSize: 17, fontWeight: "700", paddingBottom: 9, paddingTop: 7 },
  lockedField: { alignItems: "center", backgroundColor: "#F9FAFB", borderRadius: 11, flexDirection: "row", justifyContent: "space-between", marginTop: 8, paddingHorizontal: 13, paddingVertical: 12 },
  lockedText: { color: "#0A7EA4", fontSize: 15, fontWeight: "800" },
  ...
  subsectionChoiceSelected: { backgroundColor: "#F5F5F5", borderColor: "#0A7EA4" },
  subsectionChoiceText: { color: "#72809A", fontSize: 15, fontWeight: "800" },
  subsectionChoiceTextSelected: { color: "#0A7EA4" },
  primaryButton: { alignItems: "center", backgroundColor: "#0A7EA4", borderRadius: 14, flexDirection: "row", gap: 8, justifyContent: "center", marginTop: 23, paddingVertical: 15 },
