...
const styles = StyleSheet.create({
  ...
  dayButtonSelected: { backgroundColor: "#0A7EA4", borderColor: "#0A7EA4" },
  ...
  calendarNoteText: { color: "#0A7EA4", flex: 1, fontSize: 12, fontWeight: "600", lineHeight: 17 },
  dayHeading: { color: "#11181C", fontSize: 17, fontWeight: "800", marginBottom: 12 },
  ...
  time: { color: "#11181C", fontSize: 12, fontWeight: "800" },
  railDot: { backgroundColor: "#0A7EA4", borderRadius: 99, height: 7, marginTop: 9, width: 7 },
  ...
  subject: { color: "#11181C", flex: 1, fontSize: 15, fontWeight: "800" },
