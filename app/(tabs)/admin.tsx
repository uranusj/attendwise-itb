...
const styles = StyleSheet.create({
  ...
  warning: { alignItems: "flex-start", backgroundColor: "#F9FAFB", borderRadius: 15, flexDirection: "row", gap: 9, marginTop: 17, padding: 13 },
  warningText: { color: "#0A7EA4", flex: 1, fontSize: 11, fontWeight: "700", lineHeight: 16 },
  ...
  importIcon: { alignItems: "center", backgroundColor: "#F3F4F6", borderRadius: 12, height: 42, justifyContent: "center", width: 42 },
  importBody: { flex: 1 },
  importTitle: { color: "#10213F", fontSize: 14, fontWeight: "800" },
  importText: { color: "#6D7A94", fontSize: 11, lineHeight: 16, marginTop: 3 },
  importButton: { alignItems: "center", borderColor: "#0A7EA4", borderRadius: 11, borderWidth: 1, flexDirection: "row", gap: 7, justifyContent: "center", marginTop: 10, paddingVertical: 11 },
  importButtonText: { color: "#0A7EA4", fontSize: 12, fontWeight: "800" },
  ...
  status: { color: "#0A7EA4", fontSize: 11, fontWeight: "700", lineHeight: 16, marginTop: 9 },
  ...
  addButton: { alignItems: "center", backgroundColor: "#0A7EA4", borderRadius: 10, flexDirection: "row", gap: 3, paddingHorizontal: 11, paddingVertical: 9 },
  ...
  input: { backgroundColor: "#FFFFFF", borderColor: "#E5E7EB", borderRadius: 9, borderWidth: 1, color: "#10213F", fontSize: 12, fontWeight: "600", marginTop: 5, paddingHorizontal: 9, paddingVertical: 9 },
  groupRow: { flexDirection: "row", gap: 7, marginTop: 6 },
  groupButton: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#E5E7EB", borderRadius: 8, borderWidth: 1, flex: 1, paddingVertical: 8 },
  groupButtonSelected: { backgroundColor: "#F5F5F5", borderColor: "#0A7EA4" },
  groupButtonText: { color: "#72809A", fontSize: 10, fontWeight: "800" },
  groupButtonTextSelected: { color: "#0A7EA4" },
  ...
  saveButton: { alignItems: "center", backgroundColor: "#0A7EA4", borderRadius: 10, flexDirection: "row", gap: 5, paddingHorizontal: 13, paddingVertical: 10 },
  ...
  editButton: { alignItems: "center", backgroundColor: "#F3F4F6", borderRadius: 8, flexDirection: "row", gap: 4, paddingHorizontal: 9, paddingVertical: 6 },
  editText: { color: "#0A7EA4", fontSize: 10, fontWeight: "800" },
